...
#ifndef CUSTOM_FOTA_DOWNLOAD_H_
#define CUSTOM_FOTA_DOWNLOAD_H_

#include <zephyr/kernel.h>
#include <zephyr/types.h>
#include "../../custom_download_client/include/custom_download_client.h"
